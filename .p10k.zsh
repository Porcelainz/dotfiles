# Generated by Powerlevel10k configuration wizard on 2024-01-04 at 22:57 CST.
...
# angled separators, angled heads, round tails, 1 line, sparse, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=217
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=217
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=217
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_{LEFT,RIGHT}_DELIMITER=false
  # Custom icon.
